            ...
            if dominant_color[2] > 100:
                ...
                if zone_1_color[2] < 60:
                    if sum(zone_0_color) > sum(zone_2_color):
                        print("LEFT")
                        motor3.forward(speed=1)
                        motor4.forward(speed=1)
                        motor5.backward(speed=1)
                        motor6.backward(speed=1)
                        ...
                        print("RIGHT")
                        motor3.backward(speed=1)
                        motor4.backward(speed=1)
                        motor5.forward(speed=1)
                        motor6.forward(speed=1)
                        time.sleep(0.5)
                    ...
                    if sum(zone_1_color) > sum(zone_0_color) and sum(zone_1_color) > sum(zone_2_color):
                        print("FORWARD")
                        os.system('python Users\ASUS\Desktop\final_stepclimb.py')
